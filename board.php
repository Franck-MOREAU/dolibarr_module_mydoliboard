...
if ($action == 'create' && $user->rights->mydoliboard->creer)
{
	...
	print '<tr><td><span >'.$langs->trans("Ordre d'affichage").'</span></td><td><input size="10" type="text" name="ordre" value="'.$ordre.'"></td></tr>';
...
elseif ($action == 'update' && $user->rights->mydoliboard->creer)
{
	...
	print '<tr><td><span >'.$langs->trans("Ordre d'affichage").'</span></td><td><input size="10" type="text" name="ordre" value="'.$object->ordre.'"></td></tr>';
...
else
{
	...
	print '<tr><td>'.$langs->trans("Ordre d'affichage").'</td><td >'.$object->ordre.'</td></tr>';
