...
if ($action == 'add' && $user->rights->mydoliboard->creer)
{
	...
	if (! $error)
	{
		...
		$object->blocAstack		= $_POST["blocAstack"];
		$object->blocBstack		= $_POST["blocBstack"];
		$object->blocCstack		= $_POST["blocCstack"];
		$object->blocDstack		= $_POST["blocDstack"];
...
elseif ($action == 'validate' && $user->rights->mydoliboard->creer)
{
	...
	$object->blocAstack=		GETPOST("blocAstack");
	$object->blocBstack=		GETPOST("blocBstack");
	$object->blocCstack=		GETPOST("blocCstack");
	$object->blocDstack=		GETPOST("blocDstack");
...
if ($action == 'create' && $user->rights->mydoliboard->creer)
{
	...
	print '&nbsp;<input size="10" type="text" name="blocAtitle" value="'.$_POST["blocAtitle"].'">';
	print '&nbsp;Stack: ' . $form->selectyesno('blocAstack',$_POST["blocAstack"],1) . '</td></tr>';
	print '<tr><td>'.$langs->trans("blocBmode").'</td><td>'.select_blocmode("blocBmode" ,$_POST["blocBmode"]);
	print '&nbsp;<input size="10" type="text" name="blocBtitle" value="'.$_POST["blocBtitle"].'">';
	print '&nbsp;Stack: ' . $form->selectyesno('blocBstack',$_POST["blocBstack"],1) . '</td></tr>';
	print '<tr><td>'.$langs->trans("blocCmode").'</td><td>'.select_blocmode("blocCmode" ,$_POST["blocCmode"]);
	print '&nbsp;<input size="10" type="text" name="blocCtitle" value="'.$_POST["blocCtitle"].'">';
	print '&nbsp;Stack: ' . $form->selectyesno('blocCstack',$_POST["blocCstack"],1) . '</td></tr>';
	print '<tr><td>'.$langs->trans("blocDmode").'</td><td>'.select_blocmode("blocDmode" ,$_POST["blocDmode"]);
	print '&nbsp;<input size="10" type="text" name="blocDtitle" value="'.$_POST["blocDtitle"].'">';
	print '&nbsp;Stack: ' . $form->selectyesno('blocDstack',$_POST["blocDstack"],1) . '</td></tr>';
...
elseif ($action == 'update' && $user->rights->mydoliboard->creer)
{
	...
	print '&nbsp;<input size="10" type="text" name="blocAtitle" value="'.$object->blocAtitle.'">';
	print '&nbsp;Stack: ' . $form->selectyesno('blocAstack',$object->blocAstack,1) . '</td></tr>';
	print '<tr><td>'.$langs->trans("blocBmode").'</td><td>'.select_blocmode("blocBmode", $object->blocBmode);
	print '&nbsp;<input size="10" type="text" name="blocBtitle" value="'.$object->blocBtitle.'">';
	print '&nbsp;Stack: ' . $form->selectyesno('blocBstack',$object->blocBstack,1) . '</td></tr>';
	print '<tr><td>'.$langs->trans("blocCmode").'</td><td>'.select_blocmode("blocCmode", $object->blocCmode);
	print '&nbsp;<input size="10" type="text" name="blocCtitle" value="'.$object->blocCtitle.'">';
	print '&nbsp;Stack: ' . $form->selectyesno('blocCstack',$object->blocCstack,1) . '</td></tr>';
	print '<tr><td>'.$langs->trans("blocDmode").'</td><td>'.select_blocmode("blocDmode", $object->blocDmode);
	print '&nbsp;<input size="10" type="text" name="blocDtitle" value="'.$object->blocDtitle.'">';
	print '&nbsp;Stack: ' . $form->selectyesno('blocDstack',$object->blocDstack,1) . '</td></tr>';
...
else
{
	...
	print '<tr><td>'.$langs->trans("blocAmode").'</td><td >'.$langs->trans($object->blocAmode."mode").' : '.$object->blocAtitle.': Stack ->'.yn($object->blocAstack).'</td></tr>';
	print '<tr><td>'.$langs->trans("blocBmode").'</td><td >'.$langs->trans($object->blocBmode."mode").' : '.$object->blocBtitle.': Stack ->'.yn($object->blocBstack).'</td></tr>';
	print '<tr><td>'.$langs->trans("blocCmode").'</td><td >'.$langs->trans($object->blocCmode."mode").' : '.$object->blocCtitle.': Stack ->'.yn($object->blocCstack).'</td></tr>';
	print '<tr><td>'.$langs->trans("blocDmode").'</td><td >'.$langs->trans($object->blocDmode."mode").' : '.$object->blocDtitle.': Stack ->'.yn($object->blocDstack).'</td></tr>';
